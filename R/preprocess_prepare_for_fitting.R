...
#' Creat a S3 class MDfitDataSet to store data matrix
#'
#' @param P data for pre-mRNA
#' @param M data for mRNA
#' @param length.P intron length
#' @param length.M exon length
#' @param zt time points
#' @param mode "NB" or "logNormal"
#' @param fitType.disperions parameter of dispersion fitting type in DESEq2
#' @param fitType.var "separate" fit variances separate for pre-mRNA and mRNA
